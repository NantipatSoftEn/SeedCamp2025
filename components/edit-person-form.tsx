    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the information for {person?.nick_name}. All fields marked
            with * are required.
            {dataSource === "supabase" && (
              <span className="block text-sm text-green-600 mt-1">
                ✅ Changes will be saved to Supabase database
                <br />
                📁 Payment slips will be stored in Supabase Storage with person
                identification
              </span>
            )}
            {isSaving && (
              <span className="block text-sm text-blue-600 mt-2 font-medium">
                🔄 Saving changes to{" "}
                {dataSource === "mock" ? "mock data" : "database"}...
              </span>
            )}
          </DialogDescription>
        </DialogHeader>
              ...
              <CardContent className="p-4 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("nick_name", e.target.value)
                    }
                    className={errors.nick_name ? "border-red-500" : ""}
                    disabled={isSaving}
                  />
                  {errors.nick_name && (
                    <p className="text-sm text-red-500">{errors.nick_name}</p>
                  )}
                </div>
              ...
              <CardContent className="p-4 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value: "Paid" | "Pending" | "Unpaid") =>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleInputChange("group_care", value)
                    }
                    disabled={isSaving}
                  >
                    <SelectTrigger>
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleInputChange("can_go", checked)
                  }
                  disabled={isSaving}
                />
            ...
            <CardContent className="p-4 space-y-4">
              ...
              {dataSource === "supabase" && (
                <p className="text-xs text-blue-600">
                  💡 Files will be saved with format: {formData.nick_name}_
